export const abiGovernorPol = [
  ...
  },
  {
    inputs: [
      {
        internalType: "contract IERC20MintPermit",
        name: "stakingToken",
        type: "address",
      },
      {
      ...
      {
        internalType: "uint256",
        name: "initialProposalDepositAmount",
        type: "uint256",
      },
      {
        internalType: "uint256",
        name: "initialQuorumNumeratorValue",
        type: "uint256",
      },
    ],
    name: "initialize",
